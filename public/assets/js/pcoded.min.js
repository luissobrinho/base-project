    ...
    var t = this.attr("id"),
        ...
        o = {
            ...
            HandleVerticalScrollbar: function() {
                "vertical" === e.themelayout && (satnt = e.defaultVerticalMenu.desktop, "expanded" !== satnt && "compact" !== satnt || (mt = e.MenuTrigger, "click" === mt && $("#mobile-collapse,#mobile-collapse1")
                    .click(function(e) {
                        e.preventDefault();
                        ...
                        rel = t.attr("rel")
                        el = $(".pcoded-navbar")
                        if("collapsed" == $("#pcoded").attr("vertical-nav-type")) {
                            localStorage.setItem('main-menu', false);
                            $(".main-menu").slimScroll({
                                destroy: !0
                            })
                            $(".main-menu").css("overflow", "visible")
                        } else {
                            localStorage.setItem('main-menu', true);
                            $(".main-menu").slimScroll({
                                setTop: "1px",
                                size: "5px",
                                wheelStep: 10,
                    ...
                    alwaysVisible: !0,
                    allowPageScroll: !0,
                    height: $(document).find('body')[0].clientHeight+"px",
                    width: "100%"
                })));
                if(! JSON.parse(localStorage.getItem('main-menu'))) {
                    $("#mobile-collapse,#mobile-collapse1").trigger('click')
                }
            },
